    ...
    <div className="space-y-6">
      ...
      <section className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
        ...
        <form onSubmit={sendMessage} className="mt-5 flex gap-3">
          <input value={body} onChange={(event) => setBody(event.target.value)} placeholder="Scrivi un messaggio..." className="w-full rounded-2xl border border-zinc-300 bg-white px-4 py-3 text-sm" />
