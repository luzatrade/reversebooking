...
export const COOKIE_STORAGE_KEY = "hotelsdrop_cookie_consent_v1";
...
export function CookieBanner() {
  ...
  return (
    <>
      <div
        className="fixed inset-x-0 bottom-0 z-50 border-t border-zinc-200 bg-white p-4 shadow-[0_-8px_30px_rgba(0,0,0,0.08)] sm:p-5"
        role="dialog"
      ...
      >
        <div className="mx-auto flex max-w-6xl flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl space-y-2">
            ...
            <p id="cookie-banner-desc" className="text-sm leading-relaxed text-zinc-600">
              ...
              consulta la{" "}
              <Link href="/cookie-policy" className="font-medium text-zinc-900 underline underline-offset-2">
                Cookie Policy
              </Link>
              .
            </p>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:justify-end">
            <button
              type="button"
              className="rounded-lg border border-zinc-300 bg-white px-4 py-2.5 text-sm font-medium text-zinc-900 shadow-sm transition hover:bg-zinc-50"
              onClick={() => {
            ...
            <button
              type="button"
              className="rounded-lg bg-zinc-900 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-zinc-800"
...
function CookieCustomizeModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end justify-center bg-black/40 p-4 sm:items-center">
      ...
      >
        <h3 id="cookie-custom-title" className="text-lg font-semibold text-zinc-900">
          Preferenze cookie
        </h3>
        ...
        <ul className="mt-6 space-y-4">
          <li className="flex items-start justify-between gap-4 rounded-lg border border-zinc-100 bg-zinc-50 p-3">
            <div>
              <p className="text-sm font-medium text-zinc-900">Necessari</p>
          ...
          <li className="flex items-start justify-between gap-4 rounded-lg border border-zinc-200 p-3">
            <div>
              <p className="text-sm font-medium text-zinc-900">Preferenze</p>
          ...
          <li className="flex items-start justify-between gap-4 rounded-lg border border-zinc-200 p-3">
            <div>
              <p className="text-sm font-medium text-zinc-900">Analytics (futuri)</p>
