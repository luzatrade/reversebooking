...
const HotelMap = dynamic(() => import("@/components/showcase/HotelMap").then(m => ({ default: m.HotelMap })), { ssr: false, loading: () => <div className="h-[350px] w-full animate-pulse rounded-2xl bg-zinc-200" /> });
...
const ctaMaps = "inline-flex items-center justify-center gap-1.5 rounded-full bg-blue-600 px-3.5 py-2 text-xs font-bold text-white shadow-sm transition hover:bg-blue-700";
...
const ctaWhatsApp = "inline-flex items-center justify-center gap-1.5 rounded-full bg-green-600 px-3.5 py-2 text-xs font-bold text-white shadow-sm transition hover:bg-green-700";
const ctaProfile = "inline-flex items-center justify-center gap-1.5 rounded-full bg-[#0f4c81] px-3.5 py-2 text-xs font-bold text-white shadow-sm transition hover:bg-[#0a3a66]";
const ctaRequest = "inline-flex items-center justify-center gap-1.5 rounded-full bg-orange-500 px-3.5 py-2 text-xs font-bold text-white shadow-sm transition hover:bg-orange-600";
...
export function PublicShowcaseClient() {
  ...
  const [feedView, setFeedView] = useState<"both" | "structures" | "requests">("both");
...
<div className="relative z-0 mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="mb-6 flex items-center justify-center gap-1 rounded-full border border-zinc-200 bg-white p-1 shadow-sm sm:inline-flex">
          <button type="button" onClick={() => setFeedView("both")} className={`rounded-full px-4 py-2 text-sm font-bold transition ${feedView === "both" ? "bg-[#0f4c81] text-white shadow" : "text-zinc-600 hover:bg-zinc-100"}`}>Entrambe</button>
