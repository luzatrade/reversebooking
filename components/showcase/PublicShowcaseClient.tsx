...
import { Building2, CalendarDays, Euro, LayoutDashboard, MapPin, Search, Users } from "lucide-react";
...
export function PublicShowcaseClient() {
  ...
  const createRequestHref = viewer.userId ? "/inserzionista/crea-annuncio" : `/login?redirect=${encodeURIComponent("/inserzionista/crea-annuncio")}`;
