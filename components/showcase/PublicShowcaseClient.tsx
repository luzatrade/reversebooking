...
function contactMailHref(hotel: HotelAccount) {
  ...
  const body = encodeURIComponent(`Ho visto il tuo annuncio su ${BRAND_NAME} e vorrei ricevere maggiori informazioni.`);
...
function contactWhatsAppHref(hotel: HotelAccount) {
  ...
  const text = encodeURIComponent(`Ho visto il tuo annuncio su ${BRAND_NAME} e vorrei ricevere maggiori informazioni.`);
