...
/**
 * Formatta un singolo record Alloggiati Web a 168 caratteri (UTF-8).
 * Padding a sinistra del valore + spazi bianchi a destra (tranne campi numerici).
 */
...
function padDate(value: string, length: number): string {
  // Formato Alloggiati: dd/mm/yyyy — mantiene le barre
...
/** Alloggiati: no simboli speciali */
