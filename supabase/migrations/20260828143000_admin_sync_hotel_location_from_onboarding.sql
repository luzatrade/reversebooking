...
begin
  ...
  set
    ...
    specific_area = coalesce(v_row.indirizzo, specific_area),
    latitude = v_row.lat,
    longitude = v_row.lng
...
-- Casa Ena: città corretta Viverone (catalogo aveva Albiano d'Ivrea).
select public.admin_sync_hotel_location_from_onboarding('12e69b54-ab0e-4e05-b64c-8afdff610007'::uuid);
