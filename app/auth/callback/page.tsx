      ...
      <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm">
        {errorMessage ? (
          <>
            ...
            <p className="mt-4 text-sm text-zinc-600">{errorMessage}</p>
            <Link href="/login" className="mt-6 inline-flex rounded-full bg-zinc-950 px-5 py-3 text-sm font-semibold text-white">Torna al login</Link>
          </>
        ) : (
          <>
            ...
            <p className="mt-4 text-sm text-zinc-600">Se è il primo accesso social ti chiederemo di scegliere il tipo di account.</p>
          </>
        )}
      </div>
    </main>
