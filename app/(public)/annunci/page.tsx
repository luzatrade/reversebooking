          ...
          >
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm font-medium text-zinc-700">
                  Zona preferita: <span className="text-zinc-950">{request.preferredArea}</span>
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-zinc-50 px-5 py-4 text-left lg:min-w-56">
                ...
                <p className="mt-1 text-2xl font-semibold text-zinc-950">{formatCurrency(request.budget)}</p>
              </div>
            </div>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-2xl border border-zinc-100 p-4">
                ...
                <p className="mt-1 text-sm font-semibold text-zinc-900">{formatDate(request.checkIn)}</p>
              </div>
              <div className="rounded-2xl border border-zinc-100 p-4">
                <p className="text-xs text-zinc-500">Check-out</p>
                <p className="mt-1 text-sm font-semibold text-zinc-900">{formatDate(request.checkOut)}</p>
              </div>
              <div className="rounded-2xl border border-zinc-100 p-4">
