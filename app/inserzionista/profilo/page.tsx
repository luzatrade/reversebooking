    ...
    <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section className="mt-6 rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/inserzionista/crea-annuncio" className="rounded-full bg-zinc-950 px-5 py-3 text-sm font-semibold text-white dark:bg-white dark:text-zinc-950">
            Crea annuncio
          </Link>
          <Link href="/vetrina" className="rounded-full border border-zinc-300 px-5 py-3 text-sm font-semibold dark:border-zinc-700">
            Vai alla vetrina
          </Link>
        </div>
      </section>
