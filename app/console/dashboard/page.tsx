...
export default async function ConsoleDashboardPage() {
  ...
  const links = [
    ...
    { href: "/console/last-minute", label: t.console.navLastMinute, count: stats.catalogOffers - stats.agencyCatalogOffers },
    { href: "/console/pacchetti-agenzia", label: t.console.navAgencyPackages, count: stats.agencyCatalogOffers },
