...
const DESCRIPTIONS_BY_SLUG = {
  "cbh-sicitaly-group-aci-castello":
    "CBH Sicitaly Group si trova in Via Piave 25, 95021 Aci Castello (CT), alle coordinate GPS 37.555731, 15.147621, nel cuore del borgo costiero alle porte di Catania. La struttura ricettiva offre camere e suite luminose con aria condizionata, riscaldamento autonomo, connessione Wi-Fi ad alta velocità, TV a schermo piatto e bagno privato con set di cortesia. La posizione consente di raggiungere in pochi minuti il Castello normanno, il lungomare dei Ciclopi, Aci Trezza e la riviera ionica, ideale per vacanze al mare, tour sull'Etna e soggiorni di lavoro nell'area metropolitana catanese.",
  "ciclope-resort-aci-castello":
    "Ciclope Resort sorge in Via Provinciale 3, 95021 Aci Castello (CT), coordinate 37.560936, 15.158651, in una zona residenziale tranquilla a breve distanza dal mare e dal centro storico. Le camere e gli appartamenti dispongono di climatizzazione, Wi-Fi gratuito, TV, minibar e bagno privato; alcune unità offrono terrazza o vista sul panorama etneo. La struttura è adatta a famiglie e coppie che desiderano esplorare la costa verghiana, le Faraglioni di Aci Trezza e i sentieri del Parco dell'Etna, con facile accesso all'autostrada A18 e all'aeroporto di Catania Fontanarossa.",
